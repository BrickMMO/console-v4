...
if (isset($_GET['approve'])) 
{
    ...
    message_set('Approval Success', 'Audio has been deleted.');
    ...
    <?php while($record = mysqli_fetch_assoc($result)): ?>
        <tr>
            ...
            <td class="bm-table-icon">
                ...
                <?php else: ?>
                    <a href="#" onclick="return confirmModal('Are you sure you want to approve the audio <?=$record['name']?>?', '/admin/media/audio/approve/<?=$record['id']?>');">
                        <i class="fa-solid fa-thumbs-down w3-text-red"></i>
                    </a>
                <?php endif; ?>
            </td>
            <td class="bm-table-icon">
                <a href="/admin/media/audio/edit/<?=$record['id']?>">
...
<a
  ...
  onclick="loading();"
>
  <i class="fa-solid fa-file-import fa-padding-right"></i> Import Audio from Google Drive
</a>
